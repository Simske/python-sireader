#!/usr/bin/env python3
#
#    Copyright (C)    2022  Per Magnusson <per.magnusson@gmail.com>
#
...
"""
si_set_legacy_4800.py
Script to set up a remote BSF7 with serial port to auto-send, 4800 baud, which
is required for some "concentrator boxes".
